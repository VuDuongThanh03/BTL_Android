    ...
    private void loadHocPhanFromDatabase() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                @SuppressLint("Range") float soTinChiLyThuyet = cursor.getFloat(cursor.getColumnIndex("soTinChiLyThuyet"));
                @SuppressLint("Range") float soTinChiThucHanh = cursor.getFloat(cursor.getColumnIndex("soTinChiThucHanh"));
